#pragma checksum "C:\Users\CASPER\Desktop\BackEndProject\DirectList\DirectList\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2117683bdd94f5fb46a258acfd1f68f3628547d5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2117683bdd94f5fb46a258acfd1f68f3628547d5", @"/Views/Home/Index.cshtml")]
    ...
    <div class=""container"">
        <div class=""row row-grid mt-5"">
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Proin dapibus nisl ornare diam varius tempus. Aenean a quam luctus, finibus tellus ut, con");
            WriteLiteral(@"vallis eros sollicitudin turpis.</p>
            </div>
            <div class=""col-lg-4 text-center"">
                <div class=""icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary"">
            ...
            <div class=""col-lg-4 text-center"">
                ...
                <p class=""text-white mt-3"">Faucibus ante, in porttitor tellus blandit et. Phasellus tincidunt metus lectus sollicitudin feugiat pharetra consectetur.");
            WriteLiteral(@"</p>
            </div>
        </div>
    </div>
                    ...
                    <div class=""col-lg-4"">
                        <div class=""card card-lift--hover shadow border-0"">
                            ...
                            <div class=""card-body py-4"">
                                ...
                                <p>22 August 2018</p>
                                <p class=""description mb-4"">Sed sed tristique nibh iam porta volutpat finibus. Donec in aliquet urneget matti");
            WriteLiteral(@"s lorem. Pellentesque pellentesque</p>
